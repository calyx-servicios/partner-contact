==============================================================
Argentinian Accountability translations
==============================================================
...
This Module contains custom translations for the Argentinian Accountability.
...
Do this:
    ...
    * Then select Spanish(AR) / Español(AR).
    * Check the "Overwriting Existing Terms" option.
    * Click on LOAD.
    * Refresh the page.
